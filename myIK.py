...
goal_pose = Pose(position=Point(x=1, y=0.0, z=0.0), orientation=Quaternion(x=1.0, y=0.0, z=0.0, w=0.0))

# Generate joint variables for target pose
# goal_joints = bik.solve_ik(goal_pose)

# Plan a path and move to joint positions
bik.guarded_move_to_joint_position(Pose(position=Point(x=1, y=0.0, z=0.0), orientation=Quaternion(x=1.0, y=0.0, z=0.0, w=0.0)))
